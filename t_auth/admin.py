...
from .models import CustomUser, RefNewUser, DealerEmployeMapping
...
class CustomUserAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {'fields': ('username', 'password', 'email', 'mobile')}),
        (_('Personal info'), {'fields': ('email', 'username', 'mobile')}),
    ...
    list_display = ('email', 'username', 'mobile', 'is_staff')
...
admin.site.register(RefNewUser)
admin.site.register(DealerEmployeMapping)